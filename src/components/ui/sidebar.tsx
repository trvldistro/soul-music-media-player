...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      onClick={(event) => {
        onClick?.(event)
        // Let a caller veto the toggle with preventDefault(). Composing without this check
        // makes the toggle unconditional, removing any override a consumer can express.
